//! Shareholder DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new Shareholder
///
...
/// Request DTO for full update of a Shareholder
///
...
/// Request DTO for partial update of a Shareholder
///
...
pub struct PatchShareholderDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "holder_type")]
...
/// Response DTO for Shareholder entity
///
...
/// Paginated list response for Shareholder entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ShareholderListResponseDto {
    /// List of items
    pub items: Vec<ShareholderResponseDto>,
...
impl ShareholderListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<ShareholderResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Shareholder> for ShareholderResponseDto {
...
impl From<Shareholder> for ShareholderSummaryDto {
    fn from(entity: Shareholder) -> Self {
...
impl From<CreateShareholderDto> for Shareholder {
...
impl backbone_core::FromCreateDto<CreateShareholderDto> for Shareholder {
    fn from_create_dto(dto: CreateShareholderDto) -> backbone_core::ServiceResult<Self> {
        Ok(Shareholder::from(dto))
    }
}
