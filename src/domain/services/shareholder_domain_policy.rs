//! Domain policy for Shareholder aggregate
//!
...
/// Domain policy for Shareholder — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Shareholder>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ShareholderDomainPolicy = PermitAllPolicy<Shareholder>;
