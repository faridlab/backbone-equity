//! Domain policy for Dividend aggregate
//!
...
/// Domain policy for Dividend — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Dividend>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DividendDomainPolicy = PermitAllPolicy<Dividend>;
