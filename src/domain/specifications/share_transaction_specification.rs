//! Specifications for ShareTransaction aggregate
//!
...
// Each predicate implements `Specification<ShareTransaction>` and can be combined
...
//
// pub struct ActiveShareTransactionSpec;
// impl Specification<ShareTransaction> for ActiveShareTransactionSpec {
//     fn is_satisfied_by(&self, e: &ShareTransaction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
