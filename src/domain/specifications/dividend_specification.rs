//! Specifications for Dividend aggregate
//!
...
// Each predicate implements `Specification<Dividend>` and can be combined
...
//
// pub struct ActiveDividendSpec;
// impl Specification<Dividend> for ActiveDividendSpec {
//     fn is_satisfied_by(&self, e: &Dividend) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
