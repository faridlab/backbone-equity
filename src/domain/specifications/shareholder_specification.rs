//! Specifications for Shareholder aggregate
//!
...
// Each predicate implements `Specification<Shareholder>` and can be combined
...
//
// pub struct ActiveShareholderSpec;
// impl Specification<Shareholder> for ActiveShareholderSpec {
//     fn is_satisfied_by(&self, e: &Shareholder) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
