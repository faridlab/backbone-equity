CREATE TABLE IF NOT EXISTS equity.outbox_events (
...
CREATE INDEX IF NOT EXISTS idx_equity_outbox_unpublished ON equity.outbox_events (occurred_at) WHERE published_at IS NULL;
CREATE TABLE IF NOT EXISTS equity.inbox_consumed (
